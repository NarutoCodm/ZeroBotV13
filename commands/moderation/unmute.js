...
target.roles.remove(role)
  ...
  if(!reason) reason = "No reason provided by moderator"
   ...
   try {
    ...
    console.log(err)
    let check = client.emojis.cache.get("915553544210358294");
    let cross = client.emojis.cache.get("915579751886880858");
    let warn = client.emojis.cache.get("915553551416189008");
