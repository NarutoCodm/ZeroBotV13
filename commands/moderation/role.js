...
run: async (client, message, args ) => {
 let member = message.author
  ...
  .setTitle(`Add Role`)
  .setDescription(
    `<a<a:verify:880366852826599480>880366852826599480> | Succesfully gave **${member.user.username}** the ${role} role!`
    )
  ...
  .setDescription(
    `<a<a:verify:880366852826599480>880366852826599480> | Succesfully removed **${member.user.username}** the ${role} role!`
    )
