...
client.on("messageCreate", async (message) => {
    if (
        ...
        return;
 const mainServer = "933328097493782529"
if(message.mentions.members.first() && message.channel.id == "949297883453218867" && message.client.guilds.cache.get(mainServer).members.cache.has(message.mentions.members.first().user.id)) {
